                ...
                try
                {
                    ...
                    switch (imageType)
                    {
                        ...
                        case ImageType.WarehouseImport:
                            ...
                            break;
                        case ImageType.OtherPayment:
                            FileIOUtil.SaveOtherPaymentImageFile(imageName, bit);
                            break;
                    }
                }
                catch
                {
                    App.Current.ShowApplicationMessageBox("Không thể lưu ảnh, vui lòng kiểm tra lại!",
                        HPSolutionCCDevPackage.netFramework.AnubisMessageBoxType.Default,
                        HPSolutionCCDevPackage.netFramework.AnubisMessageImage.Error,
                        OwnerWindow.MainScreen,
                        "Lỗi!");
