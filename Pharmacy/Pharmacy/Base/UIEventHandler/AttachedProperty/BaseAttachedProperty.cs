...
namespace Pharmacy.Base.UIEventHandler.AttachedProperty
{
    /// <summary>
    /// A base attached property to replace the vanilla WPF attached property. Usualy use in case sealed class of WPF control.
    /// </summary>
